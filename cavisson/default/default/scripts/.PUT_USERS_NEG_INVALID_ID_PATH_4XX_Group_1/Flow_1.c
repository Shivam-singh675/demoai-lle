/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/11/2026 11:06:16
...
void Flow_1()
{
    ...
    ns_web_url("index",
        ...
        BODY_BEGIN,
            "{"id":null,"userName":"{dynamic_post_userName}","password":"{dynamic_post_password}"}",
        BODY_END
    );
    ...
    ns_web_url("index1",
        "URL={BASE_URL}/api/v1/Users/{dynamic_put_invalid_id}",
        "METHOD=PUT",
        "HEADER=Content-Type:application/json; v=1.0",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","userName":"{dynamic_put_userName}","password":"{dynamic_put_password}"}",
        BODY_END
    );
