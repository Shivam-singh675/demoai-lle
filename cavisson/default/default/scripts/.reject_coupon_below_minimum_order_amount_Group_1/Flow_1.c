/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/29/2026 07:02:58
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_link("clickPlaceOrderButton"            ,
            "url=http://boutique-qa.cav-test.com:31528/cart?coupon_error=Coupon+code+%22SAVE10%22+requires+an+order+of+at+least+%2450.+Please+try+again.&coupon_code=SAVE10",
            "tagName=BUTTON",
            "subType=RBU",
            "Navigation=1",
