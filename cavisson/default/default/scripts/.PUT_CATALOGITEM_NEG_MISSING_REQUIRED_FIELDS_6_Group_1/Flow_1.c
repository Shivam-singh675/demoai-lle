/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/03/2026 01:38:22
...
void Flow_1()
{
    ...
    ns_web_url("index1",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","catalogBrandId":"{dynamic_put_catalogBrandId}","catalogTypeId":"{dynamic_put_catalogTypeId}","description":null,"name":null,"pictureBase64":"{dynamic_put_pictureBase64}","pictureUri":"{dynamic_put_pictureUri}","pictureName":"{dynamic_put_pictureName}","price":"{dynamic_put_price}"}",
        BODY_END
    );
