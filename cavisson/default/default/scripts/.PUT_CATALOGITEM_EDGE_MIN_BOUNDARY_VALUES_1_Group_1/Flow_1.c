/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/03/2026 01:31:47
...
void Flow_1()
{
    ...
    ns_web_url("index1",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","name":"{dynamic_put_name}","description":"{dynamic_put_description}","price":"{dynamic_put_price}","pictureUri":null,"catalogTypeId":"{dynamic_put_catalogTypeId}","catalogBrandId":"{dynamic_put_catalogBrandId}","pictureBase64":null,"pictureName":null}",
        BODY_END
    );
