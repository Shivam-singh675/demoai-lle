/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/31/2026 08:05:12
...
void Flow_1()
{
    ...
    ns_web_url("index1",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","name":"{dynamic_put_name}","description":"{dynamic_put_description}","price":"{dynamic_put_price}","pictureBase64":null,"pictureUri":null,"pictureName":null,"catalogTypeId":"{dynamic_put_catalogTypeId}","catalogBrandId":"{dynamic_put_catalogBrandId}"}",
        BODY_END
    );
