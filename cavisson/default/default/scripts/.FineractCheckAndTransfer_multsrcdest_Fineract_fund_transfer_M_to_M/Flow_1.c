...
void Flow_1()
{
    ...
    ns_web_url("Login",
        ...
        BODY_BEGIN,
            "$CAVINCLUDE$=Fineract_fund_transfer_M_to_M_Flow_1_Login.json",
        BODY_END
    );
    ...
    ns_web_url("Deposit",
        ...
        "HEADER=Fineract-Platform-TenantId:default",
        BODY_BEGIN,
            "$CAVINCLUDE$=Fineract_fund_transfer_M_to_M_Flow_1_Deposit.json",
        BODY_END
    );
    ns_end_transaction("Deposit", NS_AUTO_STATUS);
    ns_page_think_time(0);
    // post-response code for page : Deposit
    // ns_replace("authkey", "\\u003d", "=");
    ...
    ns_web_url("Fund_transfer_mtom",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "$CAVINCLUDE$=Fineract_fund_transfer_M_to_M_Flow_1_Fund_transfer_mtom.text",
        BODY_END
    );
