/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/29/2026 06:59:40
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_start_transaction("clickSunglassesProduct");
        ns_link("clickSunglassesProduct"            ,
            "url=http://boutique-qa.cav-test.com:31528/",
            "tagName=A",
            "subType=RBU",
        ...
        ns_end_transaction("clickSunglassesProduct", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("clickAddToCartButton");
        ns_link("clickAddToCartButton"            ,
        ...
        ns_end_transaction("clickAddToCartButton", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("enterInvalidCouponCode");
        ns_edit_field("enterInvalidCouponCode"            ,
            "url=http://boutique-qa.cav-test.com:31528/cart",
            "value=INVALIDCODE",
            "tagName=INPUT",
            "subType=RBU",
        ...
        ns_end_transaction("enterInvalidCouponCode", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("submitInvalidCouponCode");
        ns_key_event("submitInvalidCouponCode"            ,
            "url=http://boutique-qa.cav-test.com:31528/cart?coupon_action=apply&coupon_code=INVALIDCODE",
            "value=Enter",
            "subType=RBU",
            "Navigation=1");
        ns_end_transaction("submitInvalidCouponCode", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
}
