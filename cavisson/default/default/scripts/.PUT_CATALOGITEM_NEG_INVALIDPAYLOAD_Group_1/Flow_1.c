...
void Flow_1()
{
    ...
    ns_web_url("index1",
        ...
        "METHOD=PUT",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","name":null,"description":null,"price":"{dynamic_put_price}","pictureBase64":"{dynamic_put_pictureBase64}","pictureUri":"{dynamic_put_pictureUri}","pictureName":"{dynamic_put_pictureName}","catalogTypeId":"{dynamic_put_catalogTypeId}","catalogBrandId":"{dynamic_put_catalogBrandId}"}",
        BODY_END
    );
