...
nsl_decl_var(dynamic_put_pictureFileName,DefaultValue="dynamic_put_pictureFileName",RETAINPREVALUE="NO");
...
nsl_decl_var(dynamic_put_availableStock,DefaultValue="dynamic_put_availableStock",RETAINPREVALUE="NO");
nsl_decl_var(dynamic_put_restockThreshold,DefaultValue="dynamic_put_restockThreshold",RETAINPREVALUE="NO");
nsl_decl_var(dynamic_put_maxStockThreshold,DefaultValue="dynamic_put_maxStockThreshold",RETAINPREVALUE="NO");
nsl_decl_var(dynamic_put_onReorder,DefaultValue="dynamic_put_onReorder",RETAINPREVALUE="NO");
