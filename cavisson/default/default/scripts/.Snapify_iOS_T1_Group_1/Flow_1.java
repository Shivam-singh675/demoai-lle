/*-----------------------------------------------------------------------------
    ...
    Date of generation: 07/24/2026 11:48:18
    Flow details:
...
public class Flow_1 implements NsFlow
{
    ...
    int should_add_think_time = 0;
        ...
        nsApi.ns_launch_app("Home"            ,
            ...
            "max=0",
            "matchingIndex=0",
            "failureMessage=Home page could not load successfully",
            "HERO_ELEMENT_END");
        nsApi.ns_assert("Home page loaded successfully",
            "valueType=Element",
            "propertyName=Height",
            "operator=EXIST",
            "XPATH=//XCUIElementTypeStaticText[@name=\"Clothing\"]",
        ...
        nsApi.ns_start_transaction("Category_PLP_0");
        nsApi.ns_click("Category_PLP_0"            ,
            "value=NA",
            ...
            "max=0",
            "matchingIndex=0",
            "failureMessage=Electronics category is not present on Category PLP Page",
            "HERO_ELEMENT_END");
        nsApi.ns_assert("Electronics category present on Category PLP Page",
            "valueType=Element",
            "propertyName=Height",
            "operator=EXIST",
            "XPATH=//XCUIElementTypeButton[@name=\"Electronics\"]",
            ...
            "matchingIndex=0",
            "failureMessage=Electronics category is not present on Category PLP Page");
        nsApi.ns_end_transaction("Category_PLP_0", NS_AUTO_STATUS);
        nsApi.ns_page_think_time(0.000); 


        nsApi.ns_start_transaction("Category_PLP1");
        nsApi.ns_click("Category_PLP1"            ,
            "value=NA",
        ...
        nsApi.ns_end_transaction("Category_PLP1", NS_AUTO_STATUS);
        nsApi.ns_page_think_time(0.000); 
        ...
        nsApi.ns_start_transaction("Orders");
        nsApi.ns_click("Orders"            ,
            "value=NA",
        ...
        nsApi.ns_assert("Order Page loaded successfully",
            "valueType=Element",
            "propertyName=Height",
            "operator=EXIST",
            "XPATH=//XCUIElementTypeButton[@name=\"Orders Tab 4 of 5\"]",
            ...
            "max=0",
            "matchingIndex=0",
            "failureMessage=Order Page loaded successfully");
        nsApi.ns_end_transaction("Orders", NS_AUTO_STATUS);
        nsApi.ns_page_think_time(0.000); 


        nsApi.ns_start_transaction("Home_0");
        nsApi.ns_click("Home_0"            ,
            "value=NA",
            ...
            "heroElementXPATH=//XCUIElementTypeButton[@name=\"Home Tab 1 of 5\"]",
            "heroElementACCESSIBILITYID=Home Tab 1 of 5");
        nsApi.ns_end_transaction("Home_0", NS_AUTO_STATUS);
        nsApi.ns_page_think_time(0.000); 
    return status;
    }
}
