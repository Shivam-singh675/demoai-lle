/*-----------------------------------------------------------------------------
    ...
    Date of generation: 07/27/2026 05:48:38
    Flow details:
...
public class Flow_1 implements NsFlow
{
    ...
    int should_add_think_time = 0;
        ...
        nsApi.ns_launch_app("LaunchApp"            ,
            ...
            "heroElementXPATH=//android.widget.ScrollView/android.view.View[6]/android.view.View/android.view.View[1]/android.widget.ImageView",
            "heroElementACCESSIBILITYID=Laptop Pro 15\"\n$1299.99");
        ...
        nsApi.ns_click("click_1"            ,
            "value=NA",
            "Snapshot=post_snapshot_1785131189653.png",
            "PreSnapshot=pre_snapshot_1785131189653.png",
            "PageSource=source_1785131189653.xml",
            "xpath=//android.widget.ScrollView/android.view.View[6]/android.view.View/android.view.View[1]/android.widget.ImageView",
            "accessibilityId=Laptop Pro 15\"\n$1299.99",
            "heroElementXPATH=//android.widget.Button[@content-desc=\"Add to Cart\"]",
            "heroElementXPATH1=//android.widget.Button[@content-desc='Add to Cart']",
            "heroElementACCESSIBILITYID=Add to Cart");
        ...
        nsApi.ns_click("click_2"            ,
            "value=NA",
            "Snapshot=post_snapshot_1785131198921.png",
            "PreSnapshot=pre_snapshot_1785131198921.png",
            "PageSource=source_1785131198921.xml",
            "xpath=//android.widget.Button[@content-desc=\"Add to Cart\"]",
            "xpath1=//android.widget.Button[@content-desc='Add to Cart']",
            "accessibilityId=Add to Cart");
