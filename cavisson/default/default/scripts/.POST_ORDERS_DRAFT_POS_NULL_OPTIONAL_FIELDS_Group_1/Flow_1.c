...
void Flow_1()
{
    ...
    ns_web_url("index",
        ...
        BODY_BEGIN,
            "{"buyerId":"{dynamic_post_buyerId}","items":[{"id":null,"productId":"{dynamic_post_item_productId}","productName":null,"unitPrice":"{dynamic_post_item_unitPrice}","oldUnitPrice":"{dynamic_post_item_oldUnitPrice}","quantity":"{dynamic_post_item_quantity}","pictureUrl":null}]}",
        BODY_END
    );
