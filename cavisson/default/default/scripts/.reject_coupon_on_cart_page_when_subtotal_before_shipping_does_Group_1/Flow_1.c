/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/29/2026 06:48:24
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_start_transaction("clickAddTankTopToCart");
        ns_link("clickAddTankTopToCart"            ,
            ...
            "xpath1=//BUTTON[normalize-space(.)=\"Add To Cart\"][@aria-label=\"Add Tank Top to shopping cart\"]",
            "xpath3=html/body/main/div[1]/div/div[2]/div/form/button",
            "class=cymbal-button-primary",
            "ai_locator=Add Watch Button");
        ns_end_transaction("clickAddTankTopToCart", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("clickContinueShopping");
        ns_link("clickContinueShopping"            ,
            ...
            "class=cymbal-button-primary",
            "ai_locator=Continue Shopping Link");
        ns_end_transaction("clickContinueShopping", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("clickViewTankTopDetails");
        ns_link("clickViewTankTopDetails"            ,
            "url=http://boutique-qa.cav-test.com:31528/",
            "tagName=A",
            "subType=RBU",
            "xpath=//a[@aria-label='View details for Tank Top, priced at $18.99']",
            "xpath2=/html[2]/body/main/div[2]/div/div/section/ul/li[2]/a",
            "xpath1=//A[@aria-label=\"View details for Tank Top, priced at $18.99\"]",
            "xpath3=html/body/main/div[2]/div/div/section/ul/li[2]/a",
            "ai_locator=View Tank Top Details");
        ns_end_transaction("clickViewTankTopDetails", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("clickAddTankTopToCart2");
        ns_link("clickAddTankTopToCart2"            ,
            "url=http://boutique-qa.cav-test.com:31528/cart",
            "tagName=BUTTON",
            "subType=RBU",
            "Navigation=1",
            ...
            "class=cymbal-button-primary",
            "ai_locator=Add Watch Button");
        ns_end_transaction("clickAddTankTopToCart2", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
