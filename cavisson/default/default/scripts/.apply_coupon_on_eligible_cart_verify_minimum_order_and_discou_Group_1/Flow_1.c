/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/29/2026 07:29:13
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_link("clickViewWatchDetails"            ,
            ...
            "tagName=A",
            "subType=RBU",
            "xpath=//a[@aria-label='View details for Watch, priced at €97.29']",
        ...
        ns_start_transaction("selectQuantity3");
        ns_list("selectQuantity3"            ,
            "url=http://66.220.31.130:31528/product/1YMWWN1N4O",
            "value=3",
            "tagName=SELECT",
            "subType=RBU",
            "xpath=//*[@id='quantity']/option[normalize-space()='3']",
            "xpath2=/html[2]/body/main/div/div/div[2]/div/form/div/select/option[normalize-space()='3']",
            "xpath1=//SELECT[@name=\"quantity\"][@aria-label=\"Select quantity to add to cart\"]/option[normalize-space()='3']",
            "xpath3=html/body/main/div[1]/div/div[2]/div/form/div/select/option[normalize-space()='3']",
            "id=quantity",
            "ai_locator=Quantity Dropdown");
        ns_end_transaction("selectQuantity3", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
        ...
        ns_start_transaction("enterCouponCodeSave50");
        ns_edit_field("enterCouponCodeSave50"            ,
            "url=http://66.220.31.130:31528/cart",
            "value=SAVE50",
            "tagName=INPUT",
            "subType=RBU",
        ...
        ns_end_transaction("enterCouponCodeSave50", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("clickApplyCouponButton");
        ns_link("clickApplyCouponButton"            ,
            "url=http://66.220.31.130:31528/cart?coupon_action=apply&coupon_code=SAVE50",
            "tagName=BUTTON",
            "subType=RBU",
            "Navigation=1",
