/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/29/2026 07:20:42
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_start_transaction("clickRecommendedMugLink");
        ns_link("clickRecommendedMugLink"            ,
            ...
            "xpath1=//A[@aria-label=\"View recommended product: Mug\"]",
            "xpath3=html/body/section/div/div/div/ul/li[1]/div/a",
            "ai_locator=View Mug Link");
        ns_end_transaction("clickRecommendedMugLink", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
        ...
        ns_key_event("submitCouponCode"            ,
            "url=http://66.220.31.130:31528/cart?coupon_action=apply&coupon_code=INVALIDCODE",
            "value=Enter",
            "subType=RBU",
            "Navigation=1");
