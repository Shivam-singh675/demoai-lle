/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/29/2026 07:37:30
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_start_transaction("clickContinueShoppingFromCart");
        ns_link("clickContinueShoppingFromCart"            ,
            "url=http://66.220.31.130:31528/cart",
            "tagName=A",
            "subType=RBU",
            "xpath=//a[@aria-label='Continue shopping, return to home page']",
            "role=button",
            "xpath2=/html[2]/body/main/section/a",
            "xpath1=//A[normalize-space(.)=\"Continue Shopping\"][@aria-label=\"Continue shopping, return to home page\"]",
            "xpath3=html/body/main/section/a",
            "class=cymbal-button-primary",
            "ai_locator=Continue Shopping Button");
        ns_end_transaction("clickContinueShoppingFromCart", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
        ...
        ns_link("clickAddSunglassesToCart"            ,
            "url=http://66.220.31.130:31528/product/OLJCESPC7Z",
            "tagName=BUTTON",
            "subType=RBU",
        ...
        ns_start_transaction("clickContinueShoppingFromCart2");
        ns_link("clickContinueShoppingFromCart2"            ,
            "url=http://66.220.31.130:31528/cart",
            "tagName=A",
            "subType=RBU",
            "xpath=//a[@aria-label='Continue shopping, return to home page']",
            ...
            "class=cymbal-button-primary",
            "ai_locator=Continue Shopping Button");
        ns_end_transaction("clickContinueShoppingFromCart2", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("clickReloadButton");
        ns_link("clickReloadButton"            ,
            "url=http://66.220.31.130:31528/",
            "tagName=BUTTON",
            "subType=RBU",
            "xpath=//*[@id='reload-button']",
            "xpath2=/html[2]/body/div/div/div[2]/div/button",
            "xpath1=//BUTTON[normalize-space(.)=\"Reload\"]",
            "xpath3=html/body/div[1]/div[1]/div[2]/div/button",
            "id=reload-button",
            "class=blue-button text-button",
            "ai_locator=Reload Button");
        ns_end_transaction("clickReloadButton", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
}
