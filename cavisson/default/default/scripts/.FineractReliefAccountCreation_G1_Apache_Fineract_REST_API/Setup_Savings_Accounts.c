...
void Setup_Savings_Accounts()
{
    ...
    ns_save_data_eval("/home/cavisson/work/workspace/admin/system/cavisson/data/shared/relief_account_details_entries_G1.csv",NS_TRUNC_FILE, "{clientIdParam},{savingsIdParam}");
}
