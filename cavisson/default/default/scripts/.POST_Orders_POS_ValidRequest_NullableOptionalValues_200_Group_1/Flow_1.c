/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/07/2026 07:11:09
...
void Flow_1()
{
    ...
    ns_web_url("index",
        ...
        BODY_BEGIN,
            "{"userId":null,"userName":null,"city":null,"street":null,"state":null,"country":null,"zipCode":null,"cardNumber":null,"cardHolderName":null,"cardExpiration":"{dynamic_post_cardExpiration}","cardSecurityNumber":null,"cardTypeId":"{dynamic_post_cardTypeId}","buyer":null,"items":[{"id":null,"productId":"{dynamic_post_item_productId}","productName":null,"unitPrice":"{dynamic_post_item_unitPrice}","oldUnitPrice":"{dynamic_post_item_oldUnitPrice}","quantity":"{dynamic_post_item_quantity}","pictureUrl":null}]}",
        BODY_END
    );
