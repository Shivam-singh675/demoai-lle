/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/30/2026 05:04:14
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_start_transaction("goBackFromApplyCouponPage");
        ns_browser("goBackFromApplyCouponPage"            ,
            "url=http://66.220.31.130:31528/cart/apply-coupon",
            "action=Back",
            "subType=RBU",
            "Navigation=1");
        ns_end_transaction("goBackFromApplyCouponPage", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
