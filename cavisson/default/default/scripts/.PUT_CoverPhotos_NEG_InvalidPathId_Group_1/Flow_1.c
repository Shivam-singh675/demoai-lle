/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/11/2026 11:06:21
...
void Flow_1()
{
    ...
    ns_web_url("index",
        "URL={BASE_URL}/api/v1/CoverPhotos",
        "METHOD=POST",
        "HEADER=Accept:application/json; v=1.0",
        "HEADER=Content-Type:application/json; v=1.0",
        BODY_BEGIN,
            "{"id":null,"idBook":"{dynamic_post_idBook}","url":"{dynamic_post_url}"}",
        BODY_END
    );
    ...
    ns_web_url("index1",
        "URL={BASE_URL}/api/v1/CoverPhotos/{dynamic_put_invalid_id}",
        "METHOD=PUT",
        "HEADER=Accept:application/json; v=1.0",
        "HEADER=Content-Type:application/json; v=1.0",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","idBook":"{dynamic_put_idBook}","url":"{dynamic_put_url}"}",
        BODY_END
    );
