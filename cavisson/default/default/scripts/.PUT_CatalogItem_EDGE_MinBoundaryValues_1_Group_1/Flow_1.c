/*-----------------------------------------------------------------------------
    ...
    Date of creation: 4.15.2 (build# 29)
    Flow details:
    Build details: 08/05/2026 04:46:28
...
void Flow_1()
{
    ...
    ns_web_url("index",
        ...
        BODY_BEGIN,
            "{"name":"{dynamic_post_name}","description":"{dynamic_post_description}","catalogBrandId":"{dynamic_post_catalogBrandId}","catalogTypeId":"{dynamic_post_catalogTypeId}","price":"{dynamic_post_price}"}",
        BODY_END
    );
    ...
    ns_web_url("index1",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","catalogBrandId":"{dynamic_put_catalogBrandId}","catalogTypeId":"{dynamic_put_catalogTypeId}","description":"{dynamic_put_description}","name":"{dynamic_put_name}","pictureBase64":null,"pictureUri":null,"pictureName":null,"price":"{dynamic_put_price}"}",
        BODY_END
    );
