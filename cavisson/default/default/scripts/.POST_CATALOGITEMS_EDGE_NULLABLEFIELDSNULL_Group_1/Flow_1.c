/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/05/2026 04:40:20
...
void Flow_1()
{
    ...
    ns_web_url("index",
        ...
        BODY_BEGIN,
            "{"catalogBrandId":"{dynamic_post_catalogBrandId}","catalogTypeId":"{dynamic_post_catalogTypeId}","description":null,"name":null,"pictureUri":null,"pictureBase64":null,"pictureName":null,"price":"{dynamic_post_price}"}",
        BODY_END
    );
