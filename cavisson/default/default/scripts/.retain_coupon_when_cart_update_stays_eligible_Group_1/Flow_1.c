/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/29/2026 07:23:56
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_start_transaction("clickViewRecommendedMug");
        ns_link("clickViewRecommendedMug"            ,
            "url=http://boutique-qa.cav-test.com:31528/cart?coupon_action=apply&coupon_code=SAVE10",
            "tagName=A",
            "subType=RBU",
            "xpath=//a[@aria-label='View recommended product: Mug']",
            "xpath2=/html[2]/body/section/div/div/div/ul/li/div/a",
            "xpath1=//A[@aria-label=\"View recommended product: Sunglasses\"]",
            "xpath3=html/body/section/div/div/div/ul/li[1]/div/a",
            "ai_locator=View Mug Link");
        ns_end_transaction("clickViewRecommendedMug", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("clickAddWatchToCartFromRecommendation");
        ns_link("clickAddWatchToCartFromRecommendation"            ,
            "url=http://boutique-qa.cav-test.com:31528/cart",
            "tagName=BUTTON",
            "subType=RBU",
            "Navigation=1",
            ...
            "class=cymbal-button-primary",
            "ai_locator=Add Watch Button");
        ns_end_transaction("clickAddWatchToCartFromRecommendation", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
}
