/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/31/2026 01:48:23
...
void Flow_1()
{
    ...
    ns_web_url("index",
        "URL={BASE_URL}/api/catalog-items?pageSize={dynamic_pageSize}&pageIndex={dynamic_pageIndex}&catalogBrandId={dynamic_catalogBrandId}&catalogTypeId={dynamic_catalogTypeId}",
        "METHOD=GET",
