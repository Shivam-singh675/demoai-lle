/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/30/2026 09:52:11
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ns_start_transaction("goToStoreHomePage");
        ns_browser("goToStoreHomePage"            ,
            "url=http://66.220.31.130:31528/",
            "subType=RBU",
            "Navigation=1",
            "ai_locator=Open Website");
        ns_end_transaction("goToStoreHomePage", NS_AUTO_STATUS);
        ...
        ns_start_transaction("clickPlaceOrder");
        ns_link("clickPlaceOrder"            ,
            "url=http://66.220.31.130:31528/cart?coupon_error=Invalid+coupon+code+%22INVALID123%22.+Please+try+again.&coupon_code=INVALID123",
            "tagName=BUTTON",
            "subType=RBU",
            "Navigation=1",
        ...
        ns_end_transaction("clickPlaceOrder", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
}
