/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/13/2026 05:20:03
...
void Flow_1()
{
    ...
    ns_web_url("Login",
        ...
        BODY_BEGIN,
            "$CAVINCLUDE$=Group_2_Flow_1_Login.json",
        BODY_END
    );
    ...
    ns_web_url("Deposit",
        ...
        "HEADER=Fineract-Platform-TenantId:default",
        BODY_BEGIN,
            "$CAVINCLUDE$=Group_2_Flow_1_Deposit.json",
        BODY_END
    );
    ...
    ns_web_url("Fund_transfer_mtom",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "$CAVINCLUDE$=Group_2_Flow_1_Fund_transfer_mtom.text",
        BODY_END
    );
    ...
    ns_web_url("Fund_transfer_mtom_again",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "$CAVINCLUDE$=Group_2_Flow_1_Fund_transfer_mtom_again.text",
        BODY_END
    );
