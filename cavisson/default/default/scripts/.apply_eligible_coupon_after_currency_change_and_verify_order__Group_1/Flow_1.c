/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/29/2026 06:35:03
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_start_transaction("clickWatchProductDetails");
        ns_link("clickWatchProductDetails"            ,
            "url=http://boutique-qa.cav-test.com:31528/",
            "tagName=A",
            "subType=RBU",
        ...
        ns_end_transaction("clickWatchProductDetails", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
        ...
        ns_key_event("pressEnterToApplyCoupon"            ,
            "url=http://boutique-qa.cav-test.com:31528/cart?coupon_action=apply&coupon_code=SAVE50",
            "value=Enter",
            "subType=RBU",
            "Navigation=1");
