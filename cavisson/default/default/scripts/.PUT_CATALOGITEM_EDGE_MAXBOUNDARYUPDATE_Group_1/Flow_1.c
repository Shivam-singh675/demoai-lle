/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/03/2026 02:41:50
...
void Flow_1()
{
    ...
    ns_web_url("index1",
        ...
        "METHOD=PUT",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","name":"{dynamic_put_name}","description":"{dynamic_put_description}","price":"{dynamic_put_price}","pictureBase64":null,"pictureUri":"{dynamic_put_pictureUri}","pictureName":"{dynamic_put_pictureName}","catalogTypeId":"{dynamic_put_catalogTypeId}","catalogBrandId":"{dynamic_put_catalogBrandId}"}",
        BODY_END
    );
