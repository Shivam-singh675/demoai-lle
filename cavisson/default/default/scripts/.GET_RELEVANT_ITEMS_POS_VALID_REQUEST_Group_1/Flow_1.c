/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/06/2026 08:12:11
...
void Flow_1()
{
    ...
    ns_web_url("index",
        "URL={BASE_URL}/api/catalog/items/withsemanticrelevance/{dynamic_text}?PageSize={dynamic_PageSize}&PageIndex={dynamic_PageIndex}&api-version={dynamic_api_version}",
        "METHOD=GET",
    );
