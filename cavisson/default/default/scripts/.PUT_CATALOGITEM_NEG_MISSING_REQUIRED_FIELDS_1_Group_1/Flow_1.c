/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/31/2026 01:02:05
...
void Flow_1()
{
    ...
    ns_web_url("index1",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","name":null,"description":null,"price":"{dynamic_put_price}","pictureUri":"{dynamic_put_pictureUri}","catalogTypeId":"{dynamic_put_catalogTypeId}","catalogBrandId":"{dynamic_put_catalogBrandId}","pictureBase64":null,"pictureName":null}",
        BODY_END
    );
