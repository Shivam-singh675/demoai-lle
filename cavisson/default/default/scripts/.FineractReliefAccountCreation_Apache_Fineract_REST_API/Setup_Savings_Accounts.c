/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/10/2026 10:10:30
...
void Setup_Savings_Accounts()
{
    ...
    ns_save_data_eval("/home/cavisson/work/workspace/admin/system/cavisson/data/shared/relief_account_details.csv",NS_TRUNC_FILE, "{clientIdParam},{savingsIdParam}");
}
