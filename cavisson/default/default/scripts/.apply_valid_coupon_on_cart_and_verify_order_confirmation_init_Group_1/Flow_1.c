/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/29/2026 07:08:41
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_start_transaction("clickPlaceOrderToProceedToPayment");
        ns_link("clickPlaceOrderToProceedToPayment"            ,
        ...
        ns_end_transaction("clickPlaceOrderToProceedToPayment", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
}
