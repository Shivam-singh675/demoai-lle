/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/31/2026 08:05:23
...
void Flow_1()
{
    ...
    ns_web_url("index1",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","catalogBrandId":null,"catalogTypeId":null,"description":null,"name":null,"pictureBase64":null,"pictureUri":null,"pictureName":null,"price":null}",
        BODY_END
    );
