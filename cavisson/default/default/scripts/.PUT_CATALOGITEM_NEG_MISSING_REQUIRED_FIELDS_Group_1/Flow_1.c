...
void Flow_1()
{
    ...
    ns_web_url("index1",
        ...
        "HEADER=Content-Type:application/json",
        BODY_BEGIN,
            "{"id":"{dynamic_id}","catalogBrandId":"{dynamic_put_catalogBrandId}","catalogTypeId":"{dynamic_put_catalogTypeId}","pictureBase64":null,"pictureUri":"{dynamic_put_pictureUri}","pictureName":null,"price":"{dynamic_put_price}"}",
        BODY_END
    );
