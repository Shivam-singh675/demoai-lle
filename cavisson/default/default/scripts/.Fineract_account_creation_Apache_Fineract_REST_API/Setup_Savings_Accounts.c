/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/04/2026 12:36:17
...
void Setup_Savings_Accounts()
{
    ...
    ns_web_url("Create_Savings_Product",
        ...
        BODY_BEGIN,
            "$CAVINCLUDE$=Apache_Fineract_REST_API_Setup_Savings_Accounts_Create_Savings_Product.json",
        BODY_END
    );
    ...
    ns_web_url("Activate_Savings_Account__Customer_1_",
        "URL={baseUrl}/api/v1/savingsaccounts/2?command=activate",
        "METHOD=POST",
        "HEADER=Content-Type:application/json",
        "HEADER=Fineract-Platform-TenantId:default",
        BODY_BEGIN,
