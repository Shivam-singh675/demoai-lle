...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_start_transaction("clickSunglassesDetailsLink");
        ns_link("clickSunglassesDetailsLink"            ,
            "url=http://boutique-qa.cav-test.com:31528/",
            "tagName=A",
            "subType=RBU",
        ...
        ns_end_transaction("clickSunglassesDetailsLink", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 


        ns_start_transaction("clickAddSunglassesToCartButton");
        ns_link("clickAddSunglassesToCartButton"            ,
            "url=http://boutique-qa.cav-test.com:31528/cart",
            "tagName=BUTTON",
            "subType=RBU",
            "Navigation=1",
        ...
        ns_end_transaction("clickAddSunglassesToCartButton", NS_AUTO_STATUS);
        ns_page_think_time(0.000); 
