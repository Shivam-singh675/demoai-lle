/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/24/2026 10:27:01
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_browser("Home"            ,
            ...
            "subType=RBU",
            "Snapshot=webpage_1782904012625.png",
            "Navigation=1");
        ns_end_transaction("Home", NS_AUTO_STATUS);
        ns_page_think_time(11.431); 


        ns_start_transaction("changeCurrency");
        ns_list("changeCurrency"            ,
            "url=http://66.220.31.130:30741/",
            "value=EUR",
            "tagName=SELECT",
            "subType=RBU",
            "Snapshot=webpage_1782904022583.png",
            "xpath=//SPAN[normalize-space(text())=\"$\"]/../FORM[1]/SELECT[1]",
            "csspath=#currency_code",
            "xpath2=//*[@id=\"currency_form\"]/SELECT[1]",
            "xpath1=//LABEL[normalize-space(text())=\"Select currency\"]/../SELECT[1]",
            "xpath3=HTML/BODY[1]/HEADER[1]/NAV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/FORM[1]/SELECT[1]",
            "id=currency_code");
        ns_end_transaction("changeCurrency", NS_AUTO_STATUS);
        ns_page_think_time(8.024); 
        ...
        ns_link("PDP"            ,
            ...
            "tagName=DIV",
            "subType=RBU",
            "Snapshot=webpage_1782904031480.png",
            "xpath=//IMG[@alt=\"Product image of Sunglasses\"]/../DIV[1]",
            "csspath=[href=\"\\/product\\/OLJCESPC7Z\"] div",
            "xpath1=HTML/BODY[1]/MAIN[1]/DIV[2]/DIV[1]/DIV[1]/SECTION[1]/UL[1]/LI[1]/A[1]/DIV[1]",
            "class=hot-product-card-img-overlay");
        ns_end_transaction("PDP", NS_AUTO_STATUS);
        ns_page_think_time(5.040); 


        ns_start_transaction("AddToCart");
        ns_link("AddToCart"            ,
            "url=http://66.220.31.130:30741/product/OLJCESPC7Z",
            "tagName=BUTTON",
            "subType=RBU",
            "Snapshot=webpage_1782904036856.png",
            "Navigation=1",
        ...
        ns_link("PDP_2"            ,
            ...
            "tagName=DIV",
            "subType=RBU",
            "Snapshot=webpage_1782904047782.png",
            "Navigation=1",
        ...
        ns_link("AddToCart_2"            ,
            ...
            "tagName=BUTTON",
            "subType=RBU",
            "Snapshot=webpage_1782904051545.png",
            "Navigation=1",
            "xpath=//BUTTON[normalize-space(text())=\"Add To Cart\"]",
            "csspath=button",
            "xpath2=HTML/BODY[1]/MAIN[1]/DIV[1]/DIV[1]/DIV[2]/DIV[1]/FORM[1]/BUTTON[1]",
        ...
        ns_edit_field("Entercouponcode"            ,
            ...
            "tagName=INPUT",
            "subType=RBU",
            "Snapshot=webpage_1782904094026.png",
            "Navigation=1",
        ...
        ns_link("PlaceOrder"            ,
            ...
            "tagName=BUTTON",
            "subType=RBU",
            "Snapshot=webpage_1782904094053.png",
        ...
        ns_page_think_time(9.645); 


        ns_start_transaction("ContinueShopping_2");
        ns_link("ContinueShopping_2"            ,
            "url=http://66.220.31.130:30741/cart/checkout",
            "tagName=A",
            "subType=RBU",
            "Snapshot=webpage_1782904104171.png",
            "Navigation=1",
            "xpath=//A[normalize-space(text())=\"Continue Shopping\"]",
            "csspath=[role=\"button\"]",
            "xpath2=HTML/BODY[1]/MAIN[1]/SECTION[1]/DIV[8]/DIV[1]/A[1]",
            "xpath1=//DIV[normalize-space(text())=\"Total\"]/../../DIV[8]/DIV[1]/A[@role=\"button\"][1]",
            "class=cymbal-button-primary");
        ns_end_transaction("ContinueShopping_2", NS_AUTO_STATUS);
