/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/24/2026 10:28:25
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_browser("Home"            ,
            ...
            "subType=RBU",
            "Snapshot=webpage_1783067977716.png",
            "Navigation=1");
        ns_end_transaction("Home", NS_AUTO_STATUS);
        ns_page_think_time(14.077); 
        ...
        ns_link("PDP"            ,
            ...
            "tagName=DIV",
            "subType=RBU",
            "Snapshot=webpage_1783067991677.png",
        ...
        ns_link("AddToCart"            ,
            ...
            "tagName=BUTTON",
            "subType=RBU",
            "Snapshot=webpage_1783067995945.png",
            "Navigation=1",
        ...
        ns_page_think_time(11.239); 


        ns_start_transaction("couponcode");
        ns_edit_field("couponcode"            ,
            "url=http://66.220.31.130:30741/cart",
            "value=save10",
            "tagName=INPUT",
            "subType=RBU",
            "Snapshot=webpage_1783068008075.png",
            "Navigation=1",
            ...
            "id=coupon_code");
        ns_end_transaction("couponcode", NS_AUTO_STATUS);
        ...
        ns_link("PlaceOrder"            ,
            ...
            "tagName=BUTTON",
            "subType=RBU",
            "Snapshot=webpage_1783068008100.png",
