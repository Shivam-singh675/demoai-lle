/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 07/24/2026 10:28:10
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_browser("Home"            ,
            ...
            "subType=RBU",
            "Snapshot=webpage_1782792808982.png",
            "Navigation=1");
        ns_end_transaction("Home", NS_AUTO_STATUS);
        ns_page_think_time(57.929); 
        ...
        ns_link("Cart"            ,
            ...
            "tagName=IMG",
            "subType=RBU",
            "Snapshot=webpage_1782792866722.png",
