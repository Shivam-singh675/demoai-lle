/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/03/2026 12:23:04
...
void Flow_1()
{
    ...
    int should_add_think_time = 0;
        ...
        ns_browser("Home"            ,
            ...
            "subType=RBU",
            "Snapshot=webpage_1782808822725.png",
            "Navigation=1");
        ns_end_transaction("Home", NS_AUTO_STATUS);
        ns_page_think_time(21.205); 
        ...
        ns_link("PDP"            ,
            ...
            "tagName=DIV",
            "subType=RBU",
            "Snapshot=webpage_1782808843810.png",
            "xpath=//IMG[@alt=\"Product image of Loafers\"]/../DIV[1]",
            "csspath=[href=\"\\/product\\/L9ECAV7KIM\"] div",
            "xpath1=HTML/BODY[1]/MAIN[1]/DIV[2]/DIV[1]/DIV[1]/SECTION[1]/UL[1]/LI[4]/A[1]/DIV[1]",
            "class=hot-product-card-img-overlay");
        ns_end_transaction("PDP", NS_AUTO_STATUS);
        ns_page_think_time(15.476); 


        ns_start_transaction("changeCurrency");
        ns_list("changeCurrency"            ,
            "url=http://66.220.31.130:30741/product/L9ECAV7KIM",
            "value=EUR",
            "tagName=SELECT",
            "subType=RBU",
            "Snapshot=webpage_1782808859699.png",
            "Navigation=1",
