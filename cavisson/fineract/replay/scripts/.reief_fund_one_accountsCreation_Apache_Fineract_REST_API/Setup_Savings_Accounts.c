/*-----------------------------------------------------------------------------
    ...
    Flow details:
    Build details: 08/21/2026 04:18:02
...
void Setup_Savings_Accounts()
{
    ...
    ns_save_data_eval("/home/cavisson/work/workspace/admin/system/cavisson/data/shared/relief_saving_account_details_1u.csv",NS_TRUNC_FILE, "{reliefclientIdParam},{savingsIdParam}");
}
